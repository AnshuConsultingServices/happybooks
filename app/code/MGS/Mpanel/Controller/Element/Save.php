			...
			switch ($data['type']) {
				...
				case "owl_banner":
					...
					if(isset($data['setting']['images']) && (count($data['setting']['images'])>0)){
						$dataInit = ['fullscreen', 'autoplay', 'stop_auto', 'navigation', 'pagination', 'loop', 'rtl', 'parallax'];
